...
export const MODULE_PERMISSION_ALIASES: Record<TenantSystemModule, readonly TenantSystemModule[]> = {
  ...
  CLIENTES: ["CLIENTES"],
  COTACOES: ["COTACOES", "CLIENTES", "POS"],
...
export const DEFAULT_ROLE_PERMISSION_MATRIX: Record<TenantPermissionRole, readonly PermissionGrant[]> = {
  ADMIN: [
    ...
    { module: "COTACOES", actions: ALL_STANDARD_ACTIONS },
  ...
  GERENTE: [
    ...
    { module: "COTACOES", actions: ["VIEW", "CREATE", "UPDATE", "DELETE", "APPROVE", "REJECT", "EXPORT"] },
  ...
  FARMACEUTICO: [
    ...
    { module: "COTACOES", actions: ["VIEW", "CREATE", "UPDATE", "APPROVE", "REJECT"] },
  ...
  DIRETOR_TECNICO: [
    ...
    { module: "FORNECEDORES", actions: ["VIEW"] },
    { module: "CLIENTES", actions: ["VIEW", "CREATE", "UPDATE"] },
    { module: "COTACOES", actions: ["VIEW", "CREATE", "UPDATE", "APPROVE", "REJECT", "EXPORT"] },
  ...
  CAIXA: [
    { module: "PRODUTOS", actions: ["VIEW"] },
    { module: "CLIENTES", actions: ["VIEW", "CREATE", "UPDATE"] },
    { module: "COTACOES", actions: ["VIEW", "CREATE", "UPDATE"] },
